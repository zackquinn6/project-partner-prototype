-- Consolidate Jig Saw Blade items into variants
-- First, create the main "Jig Saw Blade" tool
...
-- Create variation instances for each blade type (note: using 'tools' not 'tool')
