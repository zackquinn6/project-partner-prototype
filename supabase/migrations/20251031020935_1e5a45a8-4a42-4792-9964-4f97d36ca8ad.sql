-- Fix rebuild_phases_json_from_templates to use current normalized schema
-- The function was incorrectly using template_phases table which no longer exists
...
BEGIN
  ...
  FOR phase_record IN
    ...
    WHERE top.project_template_id = p_project_id
  ...
  LOOP
    ...
    FOR operation_record IN
      ...
      WHERE top.standard_phase_id = phase_record.id
        AND top.project_template_id = p_project_id
